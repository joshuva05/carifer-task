            ...
            <div class="card-body">
                <form action="{{ route('cars.store') }}" method="post">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-6">
                          <input type="text" class="form-control colorpicker @error('color') is-invalid @enderror" id="color" name="color" value="{{ old('color') }}">
                            @if ($errors->has('color'))
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-6">
                          <input type="text" class="form-control datepicker @error('year') is-invalid @enderror" id="year" name="year" value="{{ old('year') }}">
                            @if ($errors->has('name'))
